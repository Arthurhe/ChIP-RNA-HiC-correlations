...
# Author: Brian Sutjiadi
# Date: 10/10/16
# Description: This program takes in an annotation file (.gtf), and a sequence
#              file (.bed) and serves to condense fragmented sequencing peaks
#              into long and contiguous peaks that correspond to gene
#              annotations. If peaks fall outside of annotated genes, fragmented
#              peaks will be merged based on a threshold which is set by the
#              length of all peaks within any given gene.
